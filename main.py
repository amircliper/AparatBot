...
def start(update, context):
    if update.message.chat_id == adminChatId:
        restartVideosButton = KeyboardButton("🔴 رستارت ویدیو ها 🔴")
        changeUrlModeButton = KeyboardButton("🟡 تغییر حالت ارسال ها🟡")
        changeHashtagModeButton = KeyboardButton("🟡 تغییر حالت هشتگ ها🟡")
        changeCategoryModeButton = KeyboardButton("🔵 تغییر حالت طبقه بندی ها 🔵")
        changeUploadModeButton = KeyboardButton("🔵 تغییر حالت ارسال 🔵")
        uploadAllButton = KeyboardButton("🟠 آپلود همه ویدیو ها 🟠")
        seeAllButton = KeyboardButton("🟪 دیدن همه حالت ها 🟪")
        keyboard = [[restartVideosButton],[changeUrlModeButton,changeHashtagModeButton],[changeCategoryModeButton,changeUploadModeButton],[uploadAllButton],[seeAllButton]]
        reply_markup = ReplyKeyboardMarkup(keyboard, one_time_keyboard=False, resize_keyboard=True)
        context.bot.send_message(chat_id=update.message.chat_id, text="خوش آمدید قربان", reply_markup=reply_markup)
    else:
        context.bot.send_message(chat_id=update.message.chat_id, text='شما دسترسی به این ربات را ندارید')
...
def post(update, context):
    if update.message.text == "🔴 رستارت ویدیو ها 🔴":
        restart(update,context)
    elif update.message.text == "🟡 تغییر حالت ارسال ها🟡":
        changeurlmode(update,context)
    elif update.message.text == "🟡 تغییر حالت هشتگ ها🟡":
        changehashtagmode(update,context)
    elif update.message.text == "🔵 تغییر حالت طبقه بندی ها 🔵":
        changecategorymode(update,context)
    elif update.message.text == "🔵 تغییر حالت ارسال 🔵":
        changeuploadmode(update,context)
    elif update.message.text == "🟠 آپلود همه ویدیو ها 🟠":
        uploadall(update,context)
    elif update.message.text == "🟪 دیدن همه حالت ها 🟪":
        seeall(update,context)
    else:
        context.bot.send_message(chat_id=update.message.chat_id,text = "دستور را متوجه نمیشوم قربان")
